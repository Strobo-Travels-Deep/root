...
1. **Rabi rate reconciliation.** Earlier statement implied t_π ≈ 1.122 µs
   (→ Ω/(2π) ≈ 0.446 MHz). Confirmed value is Ω/(2π) = 0.178 MHz
   (→ t_π ≈ 2.809 µs). This logbook uses **0.178 MHz**. Flag if the 1.122
   figure referred to a different quantity (pulse length for a specific
   area? an uncalibrated drive amplitude?).
